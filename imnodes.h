...
IMNODES_API ImGuiContext* GetNodeEditorImGuiContext();
...
IMNODES_API const char* GetStyleColorName(ImNodesCol idx);
...
IMNODES_API void EditorContextSetZoom(float zoom_scale, ImVec2 zoom_center);
